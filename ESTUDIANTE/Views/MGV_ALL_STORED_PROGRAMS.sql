CREATE OR REPLACE FORCE NONEDITIONABLE VIEW estudiante.mgv_all_stored_programs (project_id,project_name,connection_id,host,port,username,catalog_id,catalog_name,schema_id,schema_name,stored_program_id,programtype,stored_program_name,package_id_fk) AS
