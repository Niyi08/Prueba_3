CREATE OR REPLACE FORCE NONEDITIONABLE VIEW estudiante.mgv_all_table_triggers (project_id,project_name,connection_id,host,port,username,catalog_id,catalog_name,dummy_flag,schema_id,schema_name,table_id,table_name,trigger_id,trigger_name) AS
