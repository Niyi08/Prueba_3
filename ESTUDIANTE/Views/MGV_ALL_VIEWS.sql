CREATE OR REPLACE FORCE NONEDITIONABLE VIEW estudiante.mgv_all_views (project_id,project_name,connection_id,host,port,username,catalog_id,catalog_name,dummy_flag,schema_id,schema_name,view_id,view_name) AS
...
WITH READ ONLY;
COMMENT ON TABLE estudiante.mgv_all_views IS 'View to iterate over all views in the system';