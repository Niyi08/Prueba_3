CREATE OR REPLACE FORCE NONEDITIONABLE VIEW estudiante.mgv_all_connections (project_id,project_name,connection_id,connection_name,host,port,username,dburl) AS
