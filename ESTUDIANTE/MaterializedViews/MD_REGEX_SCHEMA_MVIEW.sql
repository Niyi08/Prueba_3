CREATE MATERIALIZED VIEW estudiante.md_regex_schema_mview (project_id,connection_id,connection_name,catalog_id,catalog_name,schema_id,schema_name,item,"VALUE")
ORGANIZATION HEAP 
