CREATE MATERIALIZED VIEW estudiante.md_regex_mview (project_name,project_id,connection_id,connection_name,catalog_id,catalog_name,schema_id,schema_name,program_id,program_name,item,"VALUE")
ORGANIZATION HEAP 
